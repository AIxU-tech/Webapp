    ...
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          required={required}
          autoComplete="off"
          className="w-full px-4 py-3 pl-11 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent text-foreground placeholder-muted-foreground disabled:opacity-50"
        />
