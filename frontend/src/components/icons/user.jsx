...
export const CameraIcon = ({ size = 'lg', className }) => (
  <svg className={className || ICON_SIZES[size]} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export const UploadIcon = ({ size = 'md', className }) => (
  <svg className={className || ICON_SIZES[size]} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
  </svg>
);

export const ProfileIcon = ({ size = 'md', className }) => (
...
export const CommunityIcon = ({ size = 'md', className }) => (
  <svg className={className || ICON_SIZES[size]} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export const MailIcon = ({ size = 'lg', className }) => (
  <svg className={className || ICON_SIZES[size]} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
