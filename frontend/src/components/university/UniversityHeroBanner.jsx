 ...
 *
 * @param {object} university - University data with bannerUrl
...
export default function UniversityHeroBanner({
  ...
  // Use preview URL for optimistic update, otherwise use URL from API data
  const bannerUrl = bannerPreviewUrl || university?.bannerUrl || null;
