          ...
          {isFetching ? (
            ...
            searchResults.map((user) => (
              <button
                ...
                className="w-full flex items-center gap-3 p-3 hover:bg-gradient-to-r hover:from-primary/15 hover:to-primary/5 transition-colors text-left cursor-pointer"
              >
